...
function Category({ backimg,text }) {
    return (
        <div className="picbox">
            <div className="flex items-end img h-[14rem] w-[9rem] md:h-[20rem] md:w-[15rem] lg:h-[27rem] lg:w-[22rem]" style={{ backgroundImage: `url(${backimg})`, backgroundSize:"cover" }}>
                <p className="text-2xl font-normal text-white ms-3">{text}</p>
            </div>
        </div>)
